...
var $author$project$Page$Forwarding$init = function (_v0) {
	return _Utils_Tuple2(
		{forwardingGroupCountHistory: $elm$core$Maybe$Nothing, forwardingGroupCounts: _List_Nil, groupsForSelection: _List_Nil, pastDays: '14', selectedDate: '', selectedGroup: ''},
		...
		switch (msg.$) {
			...
			case 'ChangePastDays':
				...
				return _Utils_Tuple2(
					...
					A2($author$project$Page$Forwarding$getGroupCountHistory, newPastDays, model.selectedGroup));
			case 'ChangeDate':
				var newDate = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'GotForwardingCountHistory':
				...
				if (result.$ === 'Err') {
					...
					var groupHistory = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								forwardingGroupCountHistory: $elm$core$Maybe$Just(groupHistory)
							}),
						$elm$core$Platform$Cmd$none);
				}
			default:
...
var $author$project$Page$Forwarding$ChangeSelectedGroup = function (a) {
	return {$: 'ChangeSelectedGroup', a: a};
};
...
var $author$project$Page$Forwarding$viewHistoryGroupInput = function (model) {
	var options = A2(
		$elm$core$List$map,
		function (group) {
			return A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$Page$Forwarding$ChangeSelectedGroup),
						$elm$html$Html$Attributes$value(model.selectedGroup)
					]),
				options),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Page$Forwarding$viewHistoryGroupInput(model),
				function () {
				var _v0 = model.forwardingGroupCountHistory;
				if (_v0.$ === 'Just') {
					var history = _v0.a;
