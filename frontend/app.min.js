...
var $author$project$Page$Forwarding$GotInitialDate = function (a) {
	return {$: 'GotInitialDate', a: a};
};
...
var $author$project$Page$Forwarding$init = function (_v0) {
	return _Utils_Tuple2(
		{
			forwardingGroupCountHistory: $elm$core$Maybe$Nothing,
			forwardingGroupCounts: _List_Nil,
			groupHistories: _List_fromArray(
				[
					{history: $elm$core$Maybe$Nothing, selectedKey: ''},
					{history: $elm$core$Maybe$Nothing, selectedKey: ''}
				]),
			groupsForSelection: _List_Nil,
			pastDays: '14',
			selectedDate: ''
		},
		A2($elm$core$Task$perform, $author$project$Page$Forwarding$GotInitialDate, $justinmimbs$date$Date$today));
};
var $author$project$Page$Responsibilities$GotInitialDate = function (a) {
	return {$: 'GotInitialDate', a: a};
};
var $author$project$Page$Responsibilities$NoGroupSelected = {$: 'NoGroupSelected'};
var $author$project$Page$Responsibilities$init = function (_v0) {
	return _Utils_Tuple2(
		{
			groupsForSelection: _List_Nil,
			history: {historySelection: $author$project$Page$Responsibilities$NoGroupSelected, pastDays: '14', selectedGroups: _List_Nil},
			responsibilityGroupCount: _List_Nil,
			selectedDate: '',
			selectedGroup: ''
		},
		A2($elm$core$Task$perform, $author$project$Page$Responsibilities$GotInitialDate, $justinmimbs$date$Date$today));
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Page$Tasks$init = function (_v0) {
	return _Utils_Tuple2(
		{infoText: 'Hello Tasks!'},
...
var $author$project$Main$Forwarding = {$: 'Forwarding'};
var $author$project$Main$Responsibilities = {$: 'Responsibilities'};
var $author$project$Main$Tasks = {$: 'Tasks'};
...
var $author$project$Main$routeParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			$author$project$Main$Forwarding,
			$elm$url$Url$Parser$s('forwarding')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$Responsibilities,
			$elm$url$Url$Parser$s('responsibilities')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$Tasks,
			$elm$url$Url$Parser$s('tasks'))
		]));
var $author$project$Main$ForwardingPage = function (a) {
	return {$: 'ForwardingPage', a: a};
};
var $author$project$Main$GotForwardingMsg = function (a) {
	return {$: 'GotForwardingMsg', a: a};
};
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Main$toForwardingPage = F2(
	function (model, _v0) {
		var forwardingModel = _v0.a;
		var forwardingMsg = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: $author$project$Main$ForwardingPage(forwardingModel)
				}),
			A2($elm$core$Platform$Cmd$map, $author$project$Main$GotForwardingMsg, forwardingMsg));
	});
var $author$project$Main$GotResponsibilitiesMsg = function (a) {
	return {$: 'GotResponsibilitiesMsg', a: a};
};
var $author$project$Main$ResponsibilitiesPage = function (a) {
	return {$: 'ResponsibilitiesPage', a: a};
};
var $author$project$Main$toResponsibilitiesPage = F2(
	function (model, _v0) {
		var responsibilitiesModel = _v0.a;
		var responsibilitiesMsg = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: $author$project$Main$ResponsibilitiesPage(responsibilitiesModel)
				}),
			A2($elm$core$Platform$Cmd$map, $author$project$Main$GotResponsibilitiesMsg, responsibilitiesMsg));
	});
var $author$project$Main$GotTasksMsg = function (a) {
	return {$: 'GotTasksMsg', a: a};
};
var $author$project$Main$TasksPage = function (a) {
	return {$: 'TasksPage', a: a};
};
var $author$project$Main$toTasksPage = F2(
	function (model, _v0) {
		var tasksModel = _v0.a;
		var tasksMsg = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: $author$project$Main$TasksPage(tasksModel)
				}),
			A2($elm$core$Platform$Cmd$map, $author$project$Main$GotTasksMsg, tasksMsg));
	});
			...
			if (_v0.$ === 'Just') {
				switch (_v0.a.$) {
					case 'Forwarding':
						var _v1 = _v0.a;
						return A2(
							$author$project$Main$toForwardingPage,
							model,
							$author$project$Page$Forwarding$init(model.key));
					case 'Responsibilities':
						var _v2 = _v0.a;
						return A2(
							$author$project$Main$toResponsibilitiesPage,
							model,
							$author$project$Page$Responsibilities$init(model.key));
					case 'Tasks':
						var _v3 = _v0.a;
						return A2(
							$author$project$Main$toTasksPage,
							model,
							$author$project$Page$Tasks$init(model.key));
					default:
						break _v0$3;
				}
			} else {
...
var $author$project$Page$Forwarding$GotForwardingCounts = function (a) {
	return {$: 'GotForwardingCounts', a: a};
};
...
var $author$project$Page$Forwarding$ForwardingGroupCount = F4(
	function (key, label, inboundCount, outboundCount) {
		return {inboundCount: inboundCount, key: key, label: label, outboundCount: outboundCount};
	});
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $elm$json$Json$Decode$map4 = _Json_map4;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Page$Forwarding$forwardingGroupCountDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Page$Forwarding$ForwardingGroupCount,
	A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'label', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'inboundCount', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'outboundCount', $elm$json$Json$Decode$float));
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Page$Forwarding$forwardingGroupCountsDecoder = A2(
	$elm$json$Json$Decode$field,
	'countPerGroupName',
	$elm$json$Json$Decode$list($author$project$Page$Forwarding$forwardingGroupCountDecoder));
...
var $author$project$Page$Forwarding$getAllForwardingCounts = function (selectedDate) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Page$Forwarding$GotForwardingCounts, $author$project$Page$Forwarding$forwardingGroupCountsDecoder),
			url: A3(
				$elm$url$Url$Builder$crossOrigin,
				'http://localhost:5000/forwarding',
				_List_fromArray(
					['count-by-group']),
				_List_fromArray(
					[
						A2($elm$url$Url$Builder$string, 'filter-date', selectedDate)
					]))
		});
};
var $author$project$Page$Forwarding$GotForwardingCountHistory = function (a) {
	return {$: 'GotForwardingCountHistory', a: a};
};
var $author$project$Page$Forwarding$ForwardingGroupCountHistory = F2(
	function (key, counts) {
		return {counts: counts, key: key};
	});
var $author$project$Page$Forwarding$CountsForTimestamp = F3(
	function (timestamp, inbound, outbound) {
		return {inbound: inbound, outbound: outbound, timestamp: timestamp};
	});
var $elm$json$Json$Decode$map3 = _Json_map3;
var $author$project$Page$Forwarding$countsForTimestampDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Page$Forwarding$CountsForTimestamp,
	A2($elm$json$Json$Decode$field, 'countDate', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'inbound', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'outbound', $elm$json$Json$Decode$float));
var $author$project$Page$Forwarding$countsForTimestampListDecoder = $elm$json$Json$Decode$list($author$project$Page$Forwarding$countsForTimestampDecoder);
var $author$project$Page$Forwarding$forwardingGroupCountHistoryDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Page$Forwarding$ForwardingGroupCountHistory,
	A2($elm$json$Json$Decode$field, 'groupLabel', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'countHistory', $author$project$Page$Forwarding$countsForTimestampListDecoder));
var $author$project$Page$Forwarding$getGroupCountHistory = F2(
	function (pastDays, groupKey) {
		return $elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, $author$project$Page$Forwarding$GotForwardingCountHistory, $author$project$Page$Forwarding$forwardingGroupCountHistoryDecoder),
				url: A3(
					$elm$url$Url$Builder$crossOrigin,
					'http://localhost:5000/forwarding',
					_List_fromArray(
					...
					_List_fromArray(
						[
							A2($elm$url$Url$Builder$string, 'past-days', pastDays)
						]))
			});
	});
...
var $author$project$Page$Forwarding$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'GotInitialDate':
				var initialDate = msg.a;
				var newDate = $justinmimbs$date$Date$toIsoString(initialDate);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{selectedDate: newDate}),
					$author$project$Page$Forwarding$getAllForwardingCounts(newDate));
			case 'ChangeSelectedGroup':
				var groupIndex = msg.a;
				var newGroup = msg.b;
				var newGroupHistories = A2(
					$elm$core$List$indexedMap,
					F2(
						function (index, groupHistory) {
							return _Utils_eq(index, groupIndex) ? _Utils_update(
								groupHistory,
								{selectedKey: newGroup}) : groupHistory;
						}),
				...
				return _Utils_Tuple2(
					...
					A2($author$project$Page$Forwarding$getGroupCountHistory, model.pastDays, newGroup));
			case 'ChangePastDays':
				var newPastDays = msg.a;
				var historyRequests = A2(
					$elm$core$List$map,
					$author$project$Page$Forwarding$getGroupCountHistory(newPastDays),
					A2(
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(historyRequests));
			case 'ChangeDate':
				var newDate = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						...
						{selectedDate: newDate}),
					$author$project$Page$Forwarding$getAllForwardingCounts(newDate));
			case 'GotForwardingCountHistory':
				var result = msg.a;
				if (result.$ === 'Err') {
					return _Utils_Tuple2(
						_Utils_update(
					...
					var newGroupHistory = result.a;
					var newGroupHistories = A2(
						$elm$core$List$map,
						function (groupHistory) {
							return _Utils_eq(groupHistory.selectedKey, newGroupHistory.key) ? _Utils_update(
								groupHistory,
								{
									history: $elm$core$Maybe$Just(newGroupHistory)
								}) : groupHistory;
						},
						model.groupHistories);
					return _Utils_Tuple2(
			...
			default:
				...
				if (result.$ === 'Err') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{forwardingGroupCounts: groupCounts, groupsForSelection: groupKeys}),
						$elm$core$Platform$Cmd$none);
				}
		}
	});
var $author$project$Page$Responsibilities$GotResponsibilityGroupCount = function (a) {
	return {$: 'GotResponsibilityGroupCount', a: a};
};
var $author$project$Page$Responsibilities$GroupSelected = F2(
	function (a, b) {
		return {$: 'GroupSelected', a: a, b: b};
	});
var $author$project$Page$Responsibilities$GotGroupCountHistory = function (a) {
	return {$: 'GotGroupCountHistory', a: a};
};
...
var $author$project$Page$Responsibilities$FiveGroupsData = function (a) {
	return {$: 'FiveGroupsData', a: a};
};
var $author$project$Page$Responsibilities$FiveGroupsDataRecord = F6(
	function (date, groupOne, groupTwo, groupThree, groupFour, groupFive) {
		return {date: date, groupFive: groupFive, groupFour: groupFour, groupOne: groupOne, groupThree: groupThree, groupTwo: groupTwo};
	});
var $elm$json$Json$Decode$map6 = _Json_map6;
var $author$project$Page$Responsibilities$fiveGroupsHistoryDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Page$Responsibilities$FiveGroupsData,
	$elm$json$Json$Decode$list(
		A7(
			$elm$json$Json$Decode$map6,
			$author$project$Page$Responsibilities$FiveGroupsDataRecord,
			A2($elm$json$Json$Decode$field, 'countDate', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group1', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group2', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group3', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group4', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group5', $elm$json$Json$Decode$float))));
var $author$project$Page$Responsibilities$FourGroupsData = function (a) {
	return {$: 'FourGroupsData', a: a};
};
var $author$project$Page$Responsibilities$FourGroupsDataRecord = F5(
	function (date, groupOne, groupTwo, groupThree, groupFour) {
		return {date: date, groupFour: groupFour, groupOne: groupOne, groupThree: groupThree, groupTwo: groupTwo};
	});
var $elm$json$Json$Decode$map5 = _Json_map5;
var $author$project$Page$Responsibilities$fourGroupsHistoryDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Page$Responsibilities$FourGroupsData,
	$elm$json$Json$Decode$list(
		A6(
			$elm$json$Json$Decode$map5,
			$author$project$Page$Responsibilities$FourGroupsDataRecord,
			A2($elm$json$Json$Decode$field, 'countDate', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group1', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group2', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group3', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group4', $elm$json$Json$Decode$float))));
var $author$project$Page$Responsibilities$OneGroupData = function (a) {
	return {$: 'OneGroupData', a: a};
};
var $author$project$Page$Responsibilities$OneGroupDataRecord = F2(
	function (date, groupOne) {
		return {date: date, groupOne: groupOne};
	});
var $author$project$Page$Responsibilities$oneGroupHistoryDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Page$Responsibilities$OneGroupData,
	$elm$json$Json$Decode$list(
		A3(
			$elm$json$Json$Decode$map2,
			$author$project$Page$Responsibilities$OneGroupDataRecord,
			A2($elm$json$Json$Decode$field, 'countDate', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group1', $elm$json$Json$Decode$float))));
...
var $author$project$Page$Responsibilities$ThreeGroupsData = function (a) {
	return {$: 'ThreeGroupsData', a: a};
};
var $author$project$Page$Responsibilities$ThreeGroupsDataRecord = F4(
	function (date, groupOne, groupTwo, groupThree) {
		return {date: date, groupOne: groupOne, groupThree: groupThree, groupTwo: groupTwo};
	});
var $author$project$Page$Responsibilities$threeGroupsHistoryDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Page$Responsibilities$ThreeGroupsData,
	$elm$json$Json$Decode$list(
		A5(
			$elm$json$Json$Decode$map4,
			$author$project$Page$Responsibilities$ThreeGroupsDataRecord,
			A2($elm$json$Json$Decode$field, 'countDate', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group1', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group2', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group3', $elm$json$Json$Decode$float))));
var $author$project$Page$Responsibilities$TwoGroupsData = function (a) {
	return {$: 'TwoGroupsData', a: a};
};
var $author$project$Page$Responsibilities$TwoGroupsDataRecord = F3(
	function (date, groupOne, groupTwo) {
		return {date: date, groupOne: groupOne, groupTwo: groupTwo};
	});
var $author$project$Page$Responsibilities$twoGroupsHistoryDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Page$Responsibilities$TwoGroupsData,
	$elm$json$Json$Decode$list(
		A4(
			$elm$json$Json$Decode$map3,
			$author$project$Page$Responsibilities$TwoGroupsDataRecord,
			A2($elm$json$Json$Decode$field, 'countDate', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group1', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'group2', $elm$json$Json$Decode$float))));
var $author$project$Page$Responsibilities$responsibilityGroupCountHistoryDecoder = function (selectedGroupCount) {
	var historyDecoder = function () {
		switch (selectedGroupCount) {
			case 1:
				return A2($elm$json$Json$Decode$field, 'groupCountHistory', $author$project$Page$Responsibilities$oneGroupHistoryDecoder);
			case 2:
				return A2($elm$json$Json$Decode$field, 'groupCountHistory', $author$project$Page$Responsibilities$twoGroupsHistoryDecoder);
			case 3:
				return A2($elm$json$Json$Decode$field, 'groupCountHistory', $author$project$Page$Responsibilities$threeGroupsHistoryDecoder);
			case 4:
				return A2($elm$json$Json$Decode$field, 'groupCountHistory', $author$project$Page$Responsibilities$fourGroupsHistoryDecoder);
			default:
				return A2($elm$json$Json$Decode$field, 'groupCountHistory', $author$project$Page$Responsibilities$fiveGroupsHistoryDecoder);
		}
	}();
	return A3(
		$elm$json$Json$Decode$map2,
...
var $author$project$Page$Responsibilities$getHistoryData = F2(
	function (pastDays, selectedGroups) {
		return $elm$http$Http$get(
			{
				expect: A2(
					$elm$http$Http$expectJson,
					$author$project$Page$Responsibilities$GotGroupCountHistory,
					$author$project$Page$Responsibilities$responsibilityGroupCountHistoryDecoder(
						$elm$core$List$length(selectedGroups))),
				url: A3(
					$elm$url$Url$Builder$crossOrigin,
					'http://localhost:5000/responsibility-groups',
					_List_fromArray(
						['history']),
					_List_fromArray(
						[
							...
							'group-keys',
							A2($elm$core$String$join, ',', selectedGroups))
						]))
			});
	});
var $elm$core$Debug$log = _Debug_log;
var $author$project$Page$Responsibilities$LabeledCount = F3(
	function (key, label, count) {
		return {count: count, key: key, label: label};
	});
var $author$project$Page$Responsibilities$labeledCountDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Page$Responsibilities$LabeledCount,
	A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'label', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'count', $elm$json$Json$Decode$float));
var $author$project$Page$Responsibilities$labeledCountsDecoder = $elm$json$Json$Decode$list($author$project$Page$Responsibilities$labeledCountDecoder);
var $author$project$Page$Responsibilities$responsibilityGroupCountDecoder = A2($elm$json$Json$Decode$field, 'countPerGroupName', $author$project$Page$Responsibilities$labeledCountsDecoder);
var $elm$core$Debug$toString = _Debug_toString;
var $author$project$Page$Responsibilities$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'GotInitialDate':
				var date = msg.a;
				var newDateString = $justinmimbs$date$Date$toIsoString(date);
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					$elm$http$Http$get(
						{
							expect: A2($elm$http$Http$expectJson, $author$project$Page$Responsibilities$GotResponsibilityGroupCount, $author$project$Page$Responsibilities$responsibilityGroupCountDecoder),
							url: A3(
								$elm$url$Url$Builder$crossOrigin,
								'http://localhost:5000/responsibility-groups',
								_List_fromArray(
								...
								_List_fromArray(
									[
										A2($elm$url$Url$Builder$string, 'filter-date', newDateString)
									]))
						}));
			case 'ChangeDate':
				var newDateString = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{selectedDate: newDateString}),
			...
			case 'ChangePastDays':
				...
				return _Utils_Tuple2(
					...
					A2($author$project$Page$Responsibilities$getHistoryData, newPastDays, history.selectedGroups));
			case 'ChangeGroupSelection':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'ConfirmGroupSelection':
				if ($elm$core$List$length(model.history.selectedGroups) <= 5) {
					var history = model.history;
					var newSelectedGroups = A2($elm$core$List$cons, model.selectedGroup, history.selectedGroups);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
						...
						A2($author$project$Page$Responsibilities$getHistoryData, history.pastDays, newSelectedGroups));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'GotResponsibilityGroupCount':
				var result = msg.a;
				if (result.$ === 'Err') {
					return _Utils_Tuple2(
						_Utils_update(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{groupsForSelection: groupKeys, responsibilityGroupCount: counts}),
						$elm$core$Platform$Cmd$none);
				}
			default:
				var response = msg.a;
				if (response.$ === 'Err') {
					var errorMsg = response.a;
					return A2(
						$elm$core$Debug$log,
						...
						_Utils_Tuple2(
							_Utils_update(
								model,
								{
									history: {historySelection: $author$project$Page$Responsibilities$NoGroupSelected, pastDays: model.history.pastDays, selectedGroups: model.history.selectedGroups}
								}),
							$elm$core$Platform$Cmd$none));
				} else {
					var _v3 = response.a;
					var labels = _v3.a;
					var historyData = _v3.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								history: {
									historySelection: A2($author$project$Page$Responsibilities$GroupSelected, labels, historyData),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'GotForwardingMsg':
				var forwardingMsg = msg.a;
				var _v2 = model.page;
				if (_v2.$ === 'ForwardingPage') {
					var forwardingModel = _v2.a;
					return A2(
						$author$project$Main$toForwardingPage,
						model,
						A2($author$project$Page$Forwarding$update, forwardingMsg, forwardingModel));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'GotResponsibilitiesMsg':
				var responsibilitiesMsg = msg.a;
				var _v3 = model.page;
				if (_v3.$ === 'ResponsibilitiesPage') {
					var responsibilitiesModel = _v3.a;
					return A2(
						$author$project$Main$toResponsibilitiesPage,
						model,
						A2($author$project$Page$Responsibilities$update, responsibilitiesMsg, responsibilitiesModel));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			default:
...
var $author$project$Main$viewHeader = function () {
	...
	var links = A2(
		...
		_List_fromArray(
			[
				navLink(
				{label: 'Forwarding', url: '/forwarding'}),
				navLink(
				{label: 'Responsibilities', url: '/responsibilities'}),
				navLink(
				{label: 'Tasks', url: '/tasks'}),
				navLink(
				{label: 'Unknown page', url: '/unknown-url'})
			]));
	return A2(
		$elm$html$Html$nav,
		_List_Nil,
...
var $author$project$Page$Forwarding$ChangeDate = function (a) {
...
var $author$project$Page$Forwarding$viewDateInput = function (dateString) {
	return A2(
		$elm$html$Html$input,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$type_('date'),
				$elm$html$Html$Events$onInput($author$project$Page$Forwarding$ChangeDate),
				$elm$html$Html$Attributes$value(dateString)
			]),
		_List_Nil);
};
...
var $author$project$Page$Forwarding$viewForwardingCountsTable = function (counts) {
	var createRow = function (count) {
		return A2(
			$elm$html$Html$tr,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('labeled-count-table__data-row')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('labeled-count-table__cell'),
							$elm$html$Html$Attributes$class('labeled-count-table__data-cell')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(count.key)
						])),
					A2(
					$elm$html$Html$td,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('labeled-count-table__cell'),
							$elm$html$Html$Attributes$class('labeled-count-table__data-cell'),
							$elm$html$Html$Attributes$class('labeled-count-table__cell--number')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromFloat(count.inboundCount))
						])),
					A2(
					$elm$html$Html$td,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromFloat(count.outboundCount))
						]))
				]));
	};
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('labeled-count-table')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('labeled-count-table__header')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('labeled-count-table__header-row')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('labeled-count-table__cell'),
										$elm$html$Html$Attributes$class('labeled-count-table__header-cell')
									]),
								_List_fromArray(
									[
				...
				A2($elm$core$List$map, createRow, counts))
			]));
};
...
var $author$project$Page$Forwarding$timestampToDateString = function (timestamp) {
	return $justinmimbs$date$Date$toIsoString(
		A2(
			$justinmimbs$date$Date$fromPosix,
			$elm$time$Time$utc,
			$elm$time$Time$millisToPosix(
				$elm$core$Basics$round(1000 * timestamp))));
};
...
var $author$project$Page$Forwarding$viewForwardingCountsHistoryChart = function (_v0) {
	var key = _v0.key;
	var counts = _v0.counts;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('line-chart')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(key),
					...
					[
						...
						_List_fromArray(
							[
								...
								$terezka$elm_charts$Chart$Attributes$format($author$project$Page$Forwarding$timestampToDateString)
							])),
...
var $author$project$Page$Forwarding$ChangeSelectedGroup = F2(
	function (a, b) {
		return {$: 'ChangeSelectedGroup', a: a, b: b};
	});
var $elm$html$Html$option = _VirtualDom_node('option');
var $elm$html$Html$select = _VirtualDom_node('select');
var $author$project$Page$Forwarding$viewHistoryGroupInput = F3(
	function (inputIndex, selectedGroup, groupsForSelection) {
		var options = A2(
			$elm$core$List$map,
			function (group) {
				return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Page$Forwarding$ChangeSelectedGroup(inputIndex)),
							$elm$html$Html$Attributes$value(selectedGroup)
						]),
					options)
				]));
	});
var $author$project$Page$Forwarding$viewGroupHistory = F3(
	function (groupsForSelection, groupIndex, groupHistory) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('group-history')
				]),
			_List_fromArray(
				[
					A3($author$project$Page$Forwarding$viewHistoryGroupInput, groupIndex, groupHistory.selectedKey, groupsForSelection),
					function () {
					var _v0 = groupHistory.history;
					if (_v0.$ === 'Just') {
						var history = _v0.a;
						return $author$project$Page$Forwarding$viewForwardingCountsHistoryChart(history);
					} else {
						return $elm$html$Html$text('No group selected');
					}
				}()
				]));
	});
var $author$project$Page$Forwarding$viewGroupHistories = function (model) {
	var histories = A2(
		$elm$core$List$indexedMap,
		$author$project$Page$Forwarding$viewGroupHistory(model.groupsForSelection),
		model.groupHistories);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('group-histories')
			]),
		histories);
};
var $author$project$Page$Forwarding$ChangePastDays = function (a) {
	return {$: 'ChangePastDays', a: a};
};
var $author$project$Page$Forwarding$viewPastDaysInput = function (pastDays) {
	return A2(
		$elm$html$Html$input,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$type_('number'),
				$elm$html$Html$Events$onInput($author$project$Page$Forwarding$ChangePastDays),
				$elm$html$Html$Attributes$value(pastDays)
			]),
		_List_Nil);
};
var $author$project$Page$Forwarding$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('forwarding')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Forwarding')
					])),
				$author$project$Page$Forwarding$viewPastDaysInput(model.pastDays),
				$author$project$Page$Forwarding$viewGroupHistories(model),
				$author$project$Page$Forwarding$viewDateInput(model.selectedDate),
				$author$project$Page$Forwarding$viewForwardingCountsTable(model.forwardingGroupCounts)
			]));
};
var $author$project$Page$Responsibilities$ChangeDate = function (a) {
	return {$: 'ChangeDate', a: a};
};
var $author$project$Page$Responsibilities$viewDateInput = function (dateString) {
	return A2(
		$elm$html$Html$input,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$type_('date'),
				$elm$html$Html$Events$onInput($author$project$Page$Responsibilities$ChangeDate),
				$elm$html$Html$Attributes$value(dateString)
			]),
		_List_Nil);
};
var $author$project$Page$Responsibilities$fiveGroupsSeries = F2(
	function (labels, groupData) {
		return A3(
			$terezka$elm_charts$Chart$series,
			function ($) {
				return $.date;
			...
			_List_fromArray(
				[
					...
					A2(
						$elm$core$Maybe$withDefault,
						'Group1',
						A2($elm$core$Dict$get, 'group1', labels)),
					A3(
						$terezka$elm_charts$Chart$interpolated,
						function ($) {
							return $.groupOne;
					...
					A2(
						$elm$core$Maybe$withDefault,
						'Group2',
						A2($elm$core$Dict$get, 'group2', labels)),
					A3(
						$terezka$elm_charts$Chart$interpolated,
						function ($) {
							return $.groupTwo;
					...
					A2(
						$elm$core$Maybe$withDefault,
						'Group3',
						A2($elm$core$Dict$get, 'group3', labels)),
					A3(
						$terezka$elm_charts$Chart$interpolated,
						function ($) {
							return $.groupThree;
					...
					A2(
						$elm$core$Maybe$withDefault,
						'Group4',
						A2($elm$core$Dict$get, 'group4', labels)),
					A3(
						$terezka$elm_charts$Chart$interpolated,
						function ($) {
							return $.groupFour;
					...
					A2(
						$elm$core$Maybe$withDefault,
						'Group5',
						A2($elm$core$Dict$get, 'group5', labels)),
					A3(
						$terezka$elm_charts$Chart$interpolated,
						function ($) {
							return $.groupFive;
...
var $author$project$Page$Responsibilities$fourGroupsSeries = F2(
	function (labels, groupData) {
		return A3(
			$terezka$elm_charts$Chart$series,
			function ($) {
...
var $author$project$Page$Responsibilities$oneGroupSeries = F2(
	function (labels, groupData) {
		return A3(
			$terezka$elm_charts$Chart$series,
			function ($) {
...
var $author$project$Page$Responsibilities$threeGroupsSeries = F2(
	function (labels, groupData) {
		return A3(
			$terezka$elm_charts$Chart$series,
			function ($) {
...
var $author$project$Page$Responsibilities$twoGroupsSeries = F2(
	function (labels, groupData) {
		return A3(
			$terezka$elm_charts$Chart$series,
			function ($) {
...
var $author$project$Page$Responsibilities$timestampToDateString = function (timestamp) {
	return $justinmimbs$date$Date$toIsoString(
		A2(
			$justinmimbs$date$Date$fromPosix,
			$elm$time$Time$utc,
...
var $author$project$Page$Responsibilities$viewHistoryLineChart = function (lineSeries) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$terezka$elm_charts$Chart$Attributes$withGrid,
								$terezka$elm_charts$Chart$Attributes$format($author$project$Page$Responsibilities$timestampToDateString)
							])),
						$terezka$elm_charts$Chart$yLabels(
						_List_fromArray(
							[$terezka$elm_charts$Chart$Attributes$withGrid])),
...
var $author$project$Page$Responsibilities$viewHistoryChart = F2(
	function (labels, data) {
		switch (data.$) {
			case 'OneGroupData':
				var oneGroupData = data.a;
				return $author$project$Page$Responsibilities$viewHistoryLineChart(
					A2($author$project$Page$Responsibilities$oneGroupSeries, labels, oneGroupData));
			case 'TwoGroupsData':
				var twoGroupData = data.a;
				return $author$project$Page$Responsibilities$viewHistoryLineChart(
					A2($author$project$Page$Responsibilities$twoGroupsSeries, labels, twoGroupData));
			case 'ThreeGroupsData':
				var threeGroupData = data.a;
				return $author$project$Page$Responsibilities$viewHistoryLineChart(
					A2($author$project$Page$Responsibilities$threeGroupsSeries, labels, threeGroupData));
			case 'FourGroupsData':
				var fourGroupData = data.a;
				return $author$project$Page$Responsibilities$viewHistoryLineChart(
					A2($author$project$Page$Responsibilities$fourGroupsSeries, labels, fourGroupData));
			default:
				var fiveGroupData = data.a;
				return $author$project$Page$Responsibilities$viewHistoryLineChart(
					A2($author$project$Page$Responsibilities$fiveGroupsSeries, labels, fiveGroupData));
		}
	});
var $author$project$Page$Responsibilities$viewHistory = function (data) {
	if (data.$ === 'NoGroupSelected') {
		return $elm$html$Html$text('No groups selected yet');
	} else {
		var labels = data.a;
		var groupData = data.b;
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					A2($author$project$Page$Responsibilities$viewHistoryChart, labels, groupData)
				]));
	}
};
var $author$project$Page$Responsibilities$ChangeGroupSelection = function (a) {
	return {$: 'ChangeGroupSelection', a: a};
};
var $author$project$Page$Responsibilities$ConfirmGroupSelection = {$: 'ConfirmGroupSelection'};
...
var $author$project$Page$Responsibilities$ChangePastDays = function (a) {
	return {$: 'ChangePastDays', a: a};
};
var $author$project$Page$Responsibilities$viewPastDaysInput = function (pastDays) {
	return A2(
		$elm$html$Html$input,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$type_('text'),
				$elm$html$Html$Events$onInput($author$project$Page$Responsibilities$ChangePastDays),
				$elm$html$Html$Attributes$value(pastDays)
			]),
		_List_Nil);
};
var $author$project$Page$Responsibilities$viewHistorySelect = F3(
	function (pastDays, currentlySelectedGroup, groupsForSelection) {
		var options = A2(
			$elm$core$List$cons,
			A2(
				$elm$html$Html$option,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onInput($author$project$Page$Responsibilities$ChangeGroupSelection),
							$elm$html$Html$Attributes$value(currentlySelectedGroup)
						]),
					options),
					A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onClick($author$project$Page$Responsibilities$ConfirmGroupSelection)
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Ok')
						])),
					$author$project$Page$Responsibilities$viewPastDaysInput(pastDays),
					$elm$html$Html$text(currentlySelectedGroup)
				]));
	});
var $author$project$Page$Responsibilities$viewResponsibilitiesCountTable = function (labeledCounts) {
	var createRow = function (labeledCount) {
		return A2(
			$elm$html$Html$tr,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(labeledCount.key)
						])),
					A2(
					$elm$html$Html$td,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(labeledCount.label)
						])),
					A2(
					$elm$html$Html$td,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromFloat(labeledCount.count))
						]))
				]));
	};
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, createRow, labeledCounts))
			]));
};
var $author$project$Page$Responsibilities$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				A3($author$project$Page$Responsibilities$viewHistorySelect, model.history.pastDays, model.selectedGroup, model.groupsForSelection),
				$elm$html$Html$text(
				$elm$core$Debug$toString(model.history.selectedGroups)),
				$author$project$Page$Responsibilities$viewHistory(model.history.historySelection),
				$author$project$Page$Responsibilities$viewDateInput(model.selectedDate),
				$author$project$Page$Responsibilities$viewResponsibilitiesCountTable(model.responsibilityGroupCount)
			]));
};
...
var $author$project$Main$viewPage = function (page) {
	switch (page.$) {
		case 'ForwardingPage':
			...
			return A2(
				$elm$html$Html$map,
				$author$project$Main$GotForwardingMsg,
				$author$project$Page$Forwarding$view(model));
		case 'ResponsibilitiesPage':
			var model = page.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Main$GotResponsibilitiesMsg,
				$author$project$Page$Responsibilities$view(model));
		case 'TasksPage':
			var model = page.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Main$GotTasksMsg,
				$author$project$Page$Tasks$view(model));
		default:
			return $elm$html$Html$text('Other pages');
	}
};
