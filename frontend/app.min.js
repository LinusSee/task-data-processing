...
var $author$project$Page$Forwarding$init = function (_v0) {
	return _Utils_Tuple2(
		{forwardingGroupCountHistory: $elm$core$Maybe$Nothing, forwardingGroupCounts: _List_Nil, groupsForSelection: _List_Nil, selectedDate: '', selectedGroup: ''},
...
var $author$project$Page$Forwarding$getGroupCountHistory = function (groupKey) {
	return $elm$http$Http$get(
		{
		...
		switch (msg.$) {
			...
			case 'ChangeSelectedGroup':
				...
				return _Utils_Tuple2(
					...
					$author$project$Page$Forwarding$getGroupCountHistory(newGroup));
			case 'ChangeDate':
				var newDate = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
				...
				url: A3(
					...
					_List_fromArray(
						[
							...
							$elm$url$Url$Builder$string,
							'past-days',
							$elm$core$String$fromInt(pastDays)),
							A2(
							$elm$url$Url$Builder$string,
							'group-keys',
			...
			case 'ConfirmGroupSelection':
				if ($elm$core$List$length(model.history.selectedGroups) <= 5) {
					...
					return _Utils_Tuple2(
						...
						A2($author$project$Page$Responsibilities$getHistoryData, 14, newSelectedGroups));
				} else {
...
var $author$project$Page$Forwarding$viewHistoryGroupInput = F2(
	function (currentlySelectedGroup, groupsForSelection) {
		var options = A2(
			$elm$core$List$map,
			function (group) {
				return A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$Page$Forwarding$viewHistoryGroupInput, model.selectedGroup, model.groupsForSelection),
				function () {
...
var $author$project$Page$Responsibilities$viewHistorySelect = F2(
	function (currentlySelectedGroup, groupsForSelection) {
		var options = A2(
			$elm$core$List$cons,
			A2(
...
var $author$project$Page$Responsibilities$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($author$project$Page$Responsibilities$viewHistorySelect, model.selectedGroup, model.groupsForSelection),
				$elm$html$Html$text(
