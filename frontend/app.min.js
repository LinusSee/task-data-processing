...
var $author$project$Page$Tasks$init = function (key) {
	return _Utils_Tuple2(
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'GotResponsibilitiesMsg':
				...
				var _v2 = model.page;
				if (_v2.$ === 'ResponsibilitiesPage') {
					var responsibilitiesModel = _v2.a;
					return A2(
						$author$project$Main$toResponsibilitiesPage,
						model,
