	...
	return _Utils_Tuple2(
		{
			history: {
				historySelection: A2(
					$author$project$Page$Responsibilities$GroupSelected,
					$elm$core$Dict$empty,
					$author$project$Page$Responsibilities$OneGroupData(
						_List_fromArray(
							[
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					A2(
					$author$project$Page$Responsibilities$getHistoryData,
					14,
					_List_fromArray(
						['KS_LEBEN_ANTRAGSERFASSUNG_PRIVAT', 'SHU_GEWERBESERVICE', 'KS_LEBEN_VERTRAG', 'TEST_USER_GRUPPE_SHUK']))
				])));
};
			...
			case 'GotResponsibilityGroupCount':
				...
				if (result.$ === 'Err') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{responsibilityGroupCount: counts}),
						$elm$core$Platform$Cmd$none);
				}
			default:
				var response = msg.a;
...
var $author$project$Page$Responsibilities$viewHistory = function (data) {
	if (data.$ === 'NoGroupSelected') {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('No Groups selected')
				]));
	} else {
		var labels = data.a;
		var groupData = data.b;
		return A2($author$project$Page$Responsibilities$viewHistoryChart, labels, groupData);
	}
};
