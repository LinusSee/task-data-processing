...
var $author$project$Main$GotInitialDate = function (a) {
...
var $author$project$Main$Statistics = {$: 'Statistics'};
...
var $author$project$Main$routeParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$Statistics,
			$elm$url$Url$Parser$s('statistics'))
		]));
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			...
			A2($elm$core$Task$perform, $author$project$Main$GotInitialDate, $justinmimbs$date$Date$today));
	});
...
var $author$project$Main$GotResponsibilityGroupCount = function (a) {
...
var $author$project$Main$LabeledCount = F3(
...
var $author$project$Main$labeledCountDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$LabeledCount,
	A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'label', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'count', $elm$json$Json$Decode$float));
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$labeledCountsDecoder = $elm$json$Json$Decode$list($author$project$Main$labeledCountDecoder);
var $author$project$Main$responsibilityGroupCountDecoder = A2($elm$json$Json$Decode$field, 'countPerGroupName', $author$project$Main$labeledCountsDecoder);
		...
		switch (msg.$) {
			...
			case 'GotInitialDate':
				...
				return _Utils_Tuple2(
					...
					$elm$http$Http$get(
						{
							expect: A2($elm$http$Http$expectJson, $author$project$Main$GotResponsibilityGroupCount, $author$project$Main$responsibilityGroupCountDecoder),
							url: A3(
...
var $author$project$Main$viewLineChart = function (data) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Main$ChangeDate = function (a) {
...
var $author$project$Main$viewDateInput = function (dateString) {
	return A2(
		$elm$html$Html$input,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$type_('date'),
				$elm$html$Html$Events$onInput($author$project$Main$ChangeDate),
			...
			function (p, item) {
				var config = A2(
					...
					_Utils_update(
						...
						{position: $terezka$elm_charts$Chart$Item$getTop}));
				var text = function () {
...
var $author$project$Main$viewLabeledBarChart = function (data) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$terezka$elm_charts$Chart$Attributes$height(300),
						$terezka$elm_charts$Chart$Attributes$width(1600)
					]),
				_List_fromArray(
					[
						$terezka$elm_charts$Chart$yLabels(
						...
						_List_fromArray(
							[
								$terezka$elm_charts$Chart$Attributes$moveDown(24)
							])),
						A3(
						...
						_List_fromArray(
							[
								$terezka$elm_charts$Chart$Attributes$moveUp(8)
							]))
					]))
			]));
};
...
var $author$project$Main$viewResponsibilitiesTable = function (labeledCounts) {
...
var $author$project$Main$viewResponsibilities = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Responsibilities')
					])),
				$author$project$Main$viewDateInput(model.selectedDate),
				$author$project$Main$viewResponsibilitiesTable(model.responsibilityGroupCount),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('charts-container')
					]),
				_List_fromArray(
					[
						$author$project$Main$viewLabeledBarChart(model.responsibilityGroupCount)
					]))
			]));
};
var $author$project$Main$viewCharts = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$Main$viewResponsibilities(model),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Test charts')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$Main$viewLineChart(
								_List_fromArray(
									[
										{x: 0, y: 1, z: 2},
										{x: 5, y: 4, z: 6}
	...
	return {
		body: _List_fromArray(
			[
				...
				switch (_v0.$) {
					case 'Home':
						return $elm$html$Html$text('You are on the homepage');
					case 'Statistics':
						return $elm$html$Html$text('Would you look at those statistics');
					default:
						return $elm$html$Html$text('No idea what you are looking for');
				}
			}(),
				$author$project$Main$viewCharts(model)
			]),
